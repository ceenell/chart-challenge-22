...
p1_targets_list <- list(
  ...
  tar_target(
    ...
    download_tifs(sb_id = '605c987fd34ec5fa65eb6a74',
              ...
              name = NULL),
    format = 'file'),
  ## Current and future FORSCEE data - Business as usual scenarios 2020-2100 avg of RCP .5 and 8.5 (mid-high IPCC scenario)
  ## years 2020-2100
  tar_target(
  ...
  tar_target(
    ...
    p1_FORESCE_lc_tif_download %>% str_subset(
      ...
      pattern = '1900|1910|1920|1930|1940|1950|1960|1970|1980|1990|2000|2010')
    ),
