...
g <- links_urban %>%
  ...
  labs(title = "Basic access to safe drinking water",
       subtitle = "Percent of a country's population with basic access to safe drinking water\nin <span style = 'color: darkgoldenrod1;'>Urban</span> and <span style = 'color: darkorchid;'>Rural</span> areas"
       ) +
  theme_arc()
g
...
cowplot::ggdraw(xlim = c(0,1),
  ...
  draw_grob(box_black,
            ...
            hjust = 0, vjust = 1)+
  # creator
  draw_label("Matthew Morriss, USGS\nData: OWID Water, Sanitation, and Hygiene Data Explorer, WHO/UNICEF Joint Monitoring Program for Water Supply and Sanitation for 2013", 
             x = 1-plot_margin, 
             y = 0.12, 
             fontface = "italic", 
             color = "white",
